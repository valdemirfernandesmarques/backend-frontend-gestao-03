    ...
    <footer class="footer">
      <div class="footer-container">
        ...
        <div class="footer-right">
          ...
          <a href="mailto:gestaoemdanca@gmail.com" class="email-link">
...
.login-page {
  ...
  background: #181529;
  position: relative;
  padding-bottom: 80px; /* Espaço para o rodapé não cobrir o conteúdo */
}
...
/* Ícone do envelope via texto para simplificar */
